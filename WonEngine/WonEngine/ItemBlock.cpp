...
void Won::ItemBlock::Initialize()
{
	...
	blockAnimator->CreateAnimation(L"Idle", blockTexture, sVector2<float>(80, 112), sVector2<float>(16, 16), sVector2<float>(0, 0), 1, 0.1f);
	blockAnimator->CreateAnimation(L"Change", blockTexture, sVector2<float>(144, 112), sVector2<float>(16, 16), sVector2<float>(0, 0), 1, 0.1f);
